...
document.getElementById('transaction-form').addEventListener('submit', (e) => {
    ...
    getCashIn();
    getCashOut();
    valorTotalLet = valorTotal()
    getTotal(valorTotalLet);

    if (type === '2'){
        if (valorTotalLet < 0) {
            alert('Atenção. Seu saldo após cadastrar é essa despesa será negativo, deseja continuar?');
        }
    }
